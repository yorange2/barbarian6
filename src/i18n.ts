...
const dictionaries: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'action.skip': '⏭ Skip Turn (Space)',
    'action.sleep': '💤 Sleep',
    'action.wake': '⏰ Wake',
    'action.chop': '🪓 Chop {feature}',
    'action.drain': '🚜 Drain {feature}',
    ...
    'log.chop': '{unit} chopped {feature} — the city gains {prod} ⚙ and {food} 🌾.',
    'log.drain': '{unit} drained the marsh.',
    'panel.growthStalled': 'growth stalled',
  },
  zh: {
    'turn': '第 {n} 回合',
    'endTurn': '结束回合 ⏭',
    ...
    'terrain.tundra': '冻土',
    'terrain.mountain': '山脉',
    'terrain.hillsAttr': '丘陵',
    'feature.woods': '🌲 森林',
    'feature.rainforest': '🌴 雨林',
    'feature.marsh': '🌿 沼泽',
    'feature.oasis': '🏝️ 绿洲',
    ...
    'action.skip': '⏭ 跳过本回合（空格）',
    'action.sleep': '💤 睡眠',
    'action.wake': '⏰ 唤醒',
    'action.chop': '🪓 砍伐{feature}',
    'action.drain': '🚜 排干{feature}',
    ...
    'log.chop': '{unit} 砍伐了{feature}——城市获得 {prod} ⚙、{food} 🌾。',
    'log.drain': '{unit} 排干了沼泽。',
    'panel.growthStalled': '增长停滞',
  },
};
